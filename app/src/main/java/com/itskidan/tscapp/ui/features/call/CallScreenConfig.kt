...
object CallScreenConfig {
    ...
    @StringRes
    val avatarDescRes = R.string.call_screen_avatar_desc
    ...
    val colorAnswerButton = Color(0xFF4CAF50)
    ...
    @StringRes
    val buttonDescHangUpRes = R.string.call_screen_hang_up_desc

    @StringRes
    val buttonDescAnswerRes = R.string.call_screen_answer_desc

    @StringRes
    val buttonDescSpeakerRes = R.string.call_screen_speakerphone_off_on_desc

    @StringRes
    val buttonDescMicRes = R.string.call_screen_microphone_off_on_desc

    @StringRes
    val messageButtonText = R.string.call_screen_button_send_message
}